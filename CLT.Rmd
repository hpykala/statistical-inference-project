...
The histogram looks similar to the theoretical normal distribution. The original exponential distribution has very different charcteristics being always > 0, having the largest density at 0, and then exponentially decreasing.
